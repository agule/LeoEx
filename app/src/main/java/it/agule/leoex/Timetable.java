...
class TimetableData {
    ...
    static TimetableItem[] itemsToFCO = {     // Direction.RomeToFCO
            ...
            new TimetableItem("05:35", "06:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3230, 14, 0),
            ...
            new TimetableItem("06:05", "06:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3234, 14, 0),
            ...
            new TimetableItem("06:35", "07:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3238, 14, 0),
            ...
            new TimetableItem("07:05", "07:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3242, 14, 0),
            ...
            new TimetableItem("07:35", "08:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3246, 14, 0),
            ...
            new TimetableItem("08:05", "08:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3250, 14, 0),
            ...
            new TimetableItem("08:35", "09:07", EndStation.RomaTer, "00:32", TrainType.Leo, 3254, 14, 0),
            new TimetableItem("08:46", "09:33", EndStation.RomaTib, "00:47", TrainType.Reg, 22024, 8, 0),
            new TimetableItem("08:50", "09:22", EndStation.RomaTer, "00:32", TrainType.Exp, 3256, 14, 0),
            new TimetableItem("09:01", "09:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22026, 8, 0),
            new TimetableItem("09:05", "09:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3258, 14, 0),
            ...
            new TimetableItem("09:35", "10:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3262, 14, 0),
            ...
            new TimetableItem("10:05", "10:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3266, 14, 0),
            ...
            new TimetableItem("10:35", "11:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3270, 14, 0),
            new TimetableItem("10:46", "11:33", EndStation.RomaTib, "00:47", TrainType.Reg, 22040, 8, 0),
            new TimetableItem("10:50", "11:22", EndStation.RomaTer, "00:32", TrainType.Exp, 3272, 14, 0),
            new TimetableItem("11:01", "11:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22042, 8, 0),
            new TimetableItem("11:05", "11:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3274, 14, 0),
            new TimetableItem("11:16", "12:03", EndStation.RomaTib, "00:47", TrainType.Reg, 22044, 8, 0),
            new TimetableItem("11:20", "11:52", EndStation.RomaTer, "00:32", TrainType.Leo, 3268, 14, 0),
            new TimetableItem("11:31", "12:18", EndStation.RomaTib, "00:47", TrainType.Reg, 22046, 8, 0),
            new TimetableItem("11:35", "12:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3278, 14, 0),
            new TimetableItem("11:46", "12:33", EndStation.RomaTib, "00:47", TrainType.Reg, 22048, 8, 0),
            new TimetableItem("11:50", "12:22", EndStation.RomaTer, "00:32", TrainType.Exp, 3280, 14, 0),
            new TimetableItem("12:01", "12:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22050, 8, 0),
            new TimetableItem("12:05", "12:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3282, 14, 0),
            new TimetableItem("12:16", "13:03", EndStation.RomaTib, "00:47", TrainType.Reg, 22052, 8, 0),
            new TimetableItem("12:20", "12:52", EndStation.RomaTer, "00:32", TrainType.Exp, 3284, 14, 0),
            new TimetableItem("12:31", "13:18", EndStation.RomaTib, "00:47", TrainType.Reg, 22054, 8, 0),
            new TimetableItem("12:35", "13:07", EndStation.RomaTer, "00:32", TrainType.Leo, 3286, 14, 0),
            new TimetableItem("12:46", "13:33", EndStation.RomaTib, "00:47", TrainType.Reg, 22056, 8, 0),
            new TimetableItem("12:50", "13:22", EndStation.RomaTer, "00:32", TrainType.Exp, 3288, 14, 0),
            new TimetableItem("13:01", "13:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22058, 8, 0),
            new TimetableItem("13:05", "13:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3290, 14, 0),
            ...
            new TimetableItem("13:35", "14:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3294, 14, 0),
            ...
            new TimetableItem("14:05", "14:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3298, 14, 0),
            ...
            new TimetableItem("14:35", "15:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3302, 14, 0),
            new TimetableItem("14:46", "15:33", EndStation.RomaTib, "00:47", TrainType.Reg, 22072, 8, 0),
            new TimetableItem("14:50", "15:22", EndStation.RomaTer, "00:32", TrainType.Exp, 3304, 14, 0),
            new TimetableItem("15:01", "15:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22074, 8, 0),
            new TimetableItem("15:05", "15:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3306, 14, 0),
            new TimetableItem("15:16", "16:03", EndStation.RomaTib, "00:47", TrainType.Reg, 22076, 8, 0),
            new TimetableItem("15:20", "15:52", EndStation.RomaTer, "00:32", TrainType.Leo, 3308, 14, 0),
            new TimetableItem("15:31", "16:18", EndStation.RomaTib, "00:47", TrainType.Reg, 22078, 8, 0),
            new TimetableItem("15:35", "16:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3310, 14, 0),
            new TimetableItem("15:46", "16:33", EndStation.RomaTib, "00:47", TrainType.Reg, 22080, 8, 0),
            new TimetableItem("15:50", "16:22", EndStation.RomaTer, "00:32", TrainType.Exp, 3312, 14, 0),
            new TimetableItem("16:01", "16:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22082, 8, 0),
            new TimetableItem("16:05", "16:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3314, 14, 0),
            new TimetableItem("16:16", "17:03", EndStation.RomaTib, "00:47", TrainType.Reg, 22084, 8, 0),
            new TimetableItem("16:20", "16:52", EndStation.RomaTer, "00:32", TrainType.Exp, 3316, 14, 0),
            new TimetableItem("16:31", "17:18", EndStation.RomaTib, "00:47", TrainType.Reg, 22086, 8, 0),
            new TimetableItem("16:35", "17:07", EndStation.RomaTer, "00:32", TrainType.Leo, 3318, 14, 0),
            new TimetableItem("16:46", "17:33", EndStation.RomaTib, "00:47", TrainType.Reg, 22088, 8, 0),
            new TimetableItem("16:50", "17:22", EndStation.RomaTer, "00:32", TrainType.Exp, 3320, 14, 0),
            new TimetableItem("17:01", "17:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22090, 8, 0),
            new TimetableItem("17:05", "17:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3322, 14, 0),
            new TimetableItem("17:16", "18:03", EndStation.RomaTib, "00:47", TrainType.Reg, 22092, 8, 0),
            new TimetableItem("17:20", "17:52", EndStation.RomaTer, "00:32", TrainType.Exp, 3324, 14, 0),
            new TimetableItem("17:31", "18:18", EndStation.RomaTib, "00:47", TrainType.Reg, 22094, 8, 0),
            new TimetableItem("17:35", "18:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3326, 14, 0),
            new TimetableItem("17:46", "18:33", EndStation.RomaTib, "00:47", TrainType.Reg, 22096, 8, 0),
            new TimetableItem("17:50", "18:22", EndStation.RomaTer, "00:32", TrainType.Leo, 3328, 14, 0),
            new TimetableItem("18:01", "18:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22098, 8, 0),
            new TimetableItem("18:05", "18:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3330, 14, 0),
            new TimetableItem("18:16", "19:03", EndStation.RomaTib, "00:47", TrainType.Reg, 22100, 8, 0),
            new TimetableItem("18:20", "18:52", EndStation.RomaTer, "00:32", TrainType.Exp, 3332, 14, 0),
            new TimetableItem("18:31", "19:18", EndStation.RomaTib, "00:47", TrainType.Reg, 22102, 8, 0),
            new TimetableItem("18:35", "19:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3334, 14, 0),
            new TimetableItem("18:46", "19:33", EndStation.RomaTib, "00:47", TrainType.Reg, 22104, 8, 0),
            new TimetableItem("18:50", "19:22", EndStation.RomaTer, "00:32", TrainType.Exp, 3336, 14, 0),
            new TimetableItem("19:01", "19:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22106, 8, 0),
            new TimetableItem("19:05", "19:37", EndStation.RomaTer, "00:32", TrainType.Leo, 3338, 14, 0),
            new TimetableItem("19:16", "20:03", EndStation.RomaTib, "00:47", TrainType.Reg, 22108, 8, 0),
            new TimetableItem("19:20", "19:52", EndStation.RomaTer, "00:32", TrainType.Exp, 3340, 14, 0),
            new TimetableItem("19:31", "20:18", EndStation.RomaTib, "00:47", TrainType.Reg, 22110, 8, 0),
            new TimetableItem("19:35", "20:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3342, 14, 0),
            new TimetableItem("20:01", "20:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22112, 8, 0),
            new TimetableItem("20:05", "20:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3346, 14, 0),
            new TimetableItem("20:31", "21:18", EndStation.RomaTib, "00:47", TrainType.Reg, 22114, 8, 0),
            new TimetableItem("20:35", "21:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3350, 14, 0),
            new TimetableItem("21:01", "21:48", EndStation.RomaTib, "00:47", TrainType.Reg, 22116, 8, 0),
            new TimetableItem("21:05", "21:37", EndStation.RomaTer, "00:32", TrainType.Leo, 3354, 14, 0),
            new TimetableItem("21:35", "22:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3358, 14, 0),
            ...
            new TimetableItem("22:05", "22:37", EndStation.RomaTer, "00:32", TrainType.Exp, 3362, 14, 0),
            new TimetableItem("22:35", "23:07", EndStation.RomaTer, "00:32", TrainType.Exp, 3366, 14, 0)
    };
    int cntToFCO = 0;
